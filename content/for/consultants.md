...
date: 2026-05-29
tags: ["consulting", "advisory", "governance", "frameworks", "strategy"]
...
<figure class="bz-figure">
  <img src="/img/dark-cherry/architect-system.png" alt="Silhouette of a person facing a red-lit industrial tower, surveying the full system from a distance." loading="lazy">
  <figcaption>Advisory work requires seeing the full system. The consultant who maps the architecture earns the board conversation.</figcaption>
</figure>
...
<div class="bz-flow">
  <div class="bz-flow-step">
    <span class="bz-flow-step-tag">Principles</span>
    <span class="bz-flow-step-name">OECD AI Principles</span>
    <span class="bz-flow-step-desc">The international baseline for trustworthy AI. Referenced in most national frameworks and procurement requirements.</span>
  </div>
  <div class="bz-flow-arrow">→</div>
  <div class="bz-flow-step">
    <span class="bz-flow-step-tag">Regulation</span>
    <span class="bz-flow-step-name">EU AI Act Risk Framework</span>
    <span class="bz-flow-step-desc">The four risk tiers, obligations at each tier, and the timeline. Essential for any client operating in Europe.</span>
  </div>
  <div class="bz-flow-arrow">→</div>
  <div class="bz-flow-step">
    <span class="bz-flow-step-tag">Standards</span>
    <span class="bz-flow-step-name">ISO 42001</span>
    <span class="bz-flow-step-desc">The AI management system standard. Appearing in enterprise procurement and public sector tenders.</span>
  </div>
  <div class="bz-flow-arrow">→</div>
  <div class="bz-flow-step">
    <span class="bz-flow-step-tag">Operations</span>
    <span class="bz-flow-step-name">LLMOps</span>
    <span class="bz-flow-step-desc">How AI systems are operated, monitored, and maintained in production. The operational vocabulary for AI.</span>
  </div>
  <div class="bz-flow-arrow">→</div>
  <div class="bz-flow-step">
    <span class="bz-flow-step-tag">Models</span>
    <span class="bz-flow-step-name">Foundation Models</span>
    <span class="bz-flow-step-desc">What a foundation model is, how clients access them, and the vendor dependency implications.</span>
  </div>
  <div class="bz-flow-arrow">→</div>
  <div class="bz-flow-step">
    <span class="bz-flow-step-tag">Strategy</span>
    <span class="bz-flow-step-name">Wardley Mapping for AI</span>
    <span class="bz-flow-step-desc">The strategic tool that makes AI investment conversations concrete, visual, and actionable.</span>
  </div>
</div>
...
**Start here:** [OECD AI Principles](/frameworks/oecd-ai-principles/)

## Also useful

- [EU AI Act Risk Framework](/frameworks/eu-ai-act-risk-framework/): the four-tier regulatory framework and the compliance obligations at each level
- [ISO 42001](/frameworks/iso-42001/): the management system standard for AI, increasingly required in procurement and public sector contracts
- [Wardley Mapping for AI](/frameworks/wardley-mapping-ai/): the strategic mapping tool that makes AI investment conversations visual and specific
- [LLMOps](/glossary/llmops/): the operational vocabulary for AI systems in production, used by engineering and governance teams alike
