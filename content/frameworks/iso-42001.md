...
<figure class="bz-figure">
  <img src="/img/dark-cherry/architect-system.png" alt="A silhouette standing before a large structured industrial system under red light: the auditor assessing a system built to a defined standard." loading="lazy">
  <figcaption>ISO 42001 is the standard that lets auditors stand where this figure stands. It defines what a well-managed AI system looks like from the outside, so external verification becomes possible.</figcaption>
</figure>
