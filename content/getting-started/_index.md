...
description: "New to AI systems? Pick your path and start learning. Whether you want to understand AI, build something real, or find a quick answer - we have a route for you."
last_updated: 2026-05-30
---

Welcome to the AI Solutions Wiki. This page helps you find the right starting point based on your background and goals.

## Where Should You Start?

Use this guide to find the entry point that best matches your situation. Each path is designed for a specific type of learner.
...
Beyond the paths above, you can also explore the wiki through these lenses:

- **[Learn](/learn/)**: All structured learning paths in one place, organized by topic and skill level.
- **[Layers](/layers/)**: Understand how AI systems are organized conceptually across five architectural layers.
- **[Learn Through Your World](/through/)**: Alternative explanations using familiar real-world analogies like wardrobes, juggling, and craft workshops.

## Not Sure Where to Start?

If none of the paths above fit your situation:

1. **Browse the [Glossary](/glossary/)**: Look up unfamiliar terms as you encounter them.
2. **Search for a specific topic**: Use the search function to find articles on particular subjects.
3. **Start with [Learn](/learn/)**: The general learning hub accommodates all levels and helps you find your footing.
