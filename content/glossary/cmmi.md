...
description: "A process improvement framework that helps organizations improve performance across projects, divisions, and the enterprise."
date: 2026-03-28
categories: [Glossary]
...
1. Paulk, M.C., Curtis, B., Chrissis, M.B., and Weber, C.V. (1993). "Capability Maturity Model for Software, Version 1.1." SEI Technical Report CMU/SEI-93-TR-024.
2. CMMI Institute (2018). *CMMI V2.0 Model at a Glance*. ISACA/CMMI Institute.
3. Chrissis, M.B., Konrad, M., and Shrum, S. (2011). *CMMI for Development: Guidelines for Process Integration and Product Improvement*, 3rd ed. Addison-Wesley.
